  ...
  <>
    ...
    <ContentContainer style={animations.verticleSlide(`15rem`, 0)}>
      ...
      <p>
        ...
        dynamic websites and web applications. Knowledgeable in front-end
        technology as well as the principles and techniques of website
        development and maintenance. Adept at conveying complex technical
        information to a variety of technical and non-technical professional
        audiences.
        <br />
        <br />
